...
def EPSC_Calc(channel_distribution = "uniform",glutamate_scale = 1,sd = 0, mean = 0,mog_params = []):
    num_EPSCs = 200
    ...
    with tqdm(total=num_EPSCs, desc=f"Processing EPSCs for {channel_distribution} {glutamate_scale}") as pbar:
        ...
        while count < num_EPSCs: #marking EPSCs
            ...
            num_channels = pick_number_channels(channel_distribution, sd=sd, mean=mean)
    ...
    #plt.savefig(f"Simulated_Data_ARO/{channel_distribution}_2000channels_{glutamate_scale}mM_rawEPSCs.png")
    ...
    file_path = f'C:/Users/jawad/Downloads/Python-EPSC-NSFA-Pipeline/simulation_optimization/EPSCs_Dataframe_{channel_distribution}_1000traces_{glutamate_scale}mM_1000channels.xlsx'
    ...
    return EPSCs_df, all_total_channel_nums
